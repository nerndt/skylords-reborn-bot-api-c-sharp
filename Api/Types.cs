...
{
    public const UInt64 VERSION = 25;
}
public enum Upgrade
{
    U0 = 0,
...
public class SingleTargetHolder
{
    ...
    public SingleTarget Get()
    {
        ...
        throw new InvalidOperationException("Impossible, because all cases was handled above");
    }
...
/// </summary>
public class MountStateHolder
{
    /// <summary>
    ///  not mounted on any barrier (EA's 0)
    /// </summary>
    [JsonPropertyName("Unmounted")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public MountStateUnmounted? Unmounted { get; set; }
    /// <summary>
    ///  squad in process of mounting to barrier (EA's 1, 2, 3)
    /// </summary>
    [JsonPropertyName("MountingSquad")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public MountStateMountingSquad? MountingSquad { get; set; }
    /// <summary>
    ///  figure in process of mounting to barrier (EA's 1, 2, 3)
    /// </summary>
    [JsonPropertyName("MountingFigure")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public MountStateMountingFigure? MountingFigure { get; set; }
    /// <summary>
    ///  squad mounted to barrier (EA's 4)
    /// </summary>
    [JsonPropertyName("MountedSquad")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public MountStateMountedSquad? MountedSquad { get; set; }
    /// <summary>
    ///  figure mounted to barrier (EA's 4)
    /// </summary>
    [JsonPropertyName("MountedFigure")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public MountStateMountedFigure? MountedFigure { get; set; }
    /// <summary>
    ///  Unknown (EA's 5, 6) please report a bug (ideally with steps to reproduce)
    /// </summary>
    [JsonPropertyName("Unknown")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public MountStateUnknown? Unknown { get; set; }

    public MountState Get()
    {
        if (Unmounted != null) { return Unmounted; }
        if (MountingSquad != null) { return MountingSquad; }
        if (MountingFigure != null) { return MountingFigure; }
        if (MountedSquad != null) { return MountedSquad; }
        if (MountedFigure != null) { return MountedFigure; }
    ...
    public MountStateHolder(MountStateMountingFigure v) { MountingFigure = v; }
    public MountStateHolder(MountStateMountedSquad v) { MountedSquad = v; }
    public MountStateHolder(MountStateMountedFigure v) { MountedFigure = v; }
    public MountStateHolder(MountStateUnknown v) { Unknown = v; }
    public MountStateHolder(MountState v)
    {
        switch (v)
        {
            case MountStateUnmounted s:
                Unmounted = s;
                break;
            case MountStateMountingSquad s:
                MountingSquad = s;
                break;
            case MountStateMountingFigure s:
                MountingFigure = s;
                break;
            case MountStateMountedSquad s:
                MountedSquad = s;
                break;
            case MountStateMountedFigure s:
                MountedFigure = s;
                break;
            case MountStateUnknown s:
                Unknown = s;
                break;
        }
    }
...
[JsonDerivedType(typeof(MountStateUnmounted))]
[JsonDerivedType(typeof(MountStateMountingSquad))]
[JsonDerivedType(typeof(MountStateMountingFigure))]
[JsonDerivedType(typeof(MountStateMountedSquad))]
[JsonDerivedType(typeof(MountStateMountedFigure))]
[JsonDerivedType(typeof(MountStateUnknown))]
public /*abstract*/ class MountState { }

/// <summary>
///  not mounted on any barrier (EA's 0)
/// </summary>
public sealed class MountStateUnmounted : MountState
{
}
...
///  squad in process of mounting to barrier (EA's 1, 2, 3)
/// </summary>
public sealed class MountStateMountingSquad : MountState
{
    [JsonPropertyName("barrier")]
    public required EntityId Barrier { get; set; }
}

/// <summary>
///  figure in process of mounting to barrier (EA's 1, 2, 3)
/// </summary>
public sealed class MountStateMountingFigure : MountState
{
    [JsonPropertyName("barrier")]
    public required EntityId Barrier { get; set; }
...
///  squad mounted to barrier (EA's 4)
/// </summary>
public sealed class MountStateMountedSquad : MountState
{
    [JsonPropertyName("barrier")]
    public required EntityId Barrier { get; set; }
}
...
///  figure mounted to barrier (EA's 4)
/// </summary>
public sealed class MountStateMountedFigure : MountState
{
    [JsonPropertyName("barrier")]
    public required EntityId Barrier { get; set; }
    [JsonPropertyName("slot")]
...
///  Unknown (EA's 5, 6) please report a bug (ideally with steps to reproduce)
/// </summary>
public sealed class MountStateUnknown : MountState
{
    [JsonPropertyName("mount_state")]
    public required byte MountState { get; set; }
    [JsonPropertyName("enter_exit_barrier_module")]
    public required UInt32 EnterExitBarrierModule { get; set; }
    [JsonPropertyName("target_barrier_module")]
    public required UInt32 TargetBarrierModule { get; set; }
    [JsonPropertyName("current_barrier_module")]
    public required UInt32 CurrentBarrierModule { get; set; }
    [JsonPropertyName("slot")]
    public required UInt32 Slot { get; set; }
}
...
public sealed class AspectMountBarrier : Aspect
{
    ...
    public required MountStateHolder State { get; set; }
}
...
public class PowerSlot
{
    ...
    [JsonPropertyName("state")]
    public required BuildState State { get; set; }
    [JsonPropertyName("team")]
    public required byte Team { get; set; }
}
...
public class CommandHolder
{
    ...
    [JsonPropertyName("GroupKillEntity")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public CommandGroupKillEntity? GroupKillEntity { get; set; }
    [JsonPropertyName("GroupSacrifice")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public CommandGroupSacrifice? GroupSacrifice { get; set; }
    [JsonPropertyName("PortalDefineExitPoint")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public CommandPortalDefineExitPoint? PortalDefineExitPoint { get; set; }
    [JsonPropertyName("PortalRemoveExitPoint")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public CommandPortalRemoveExitPoint? PortalRemoveExitPoint { get; set; }
    [JsonPropertyName("TunnelMakeExitPoint")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public CommandTunnelMakeExitPoint? TunnelMakeExitPoint { get; set; }
    ...
    public Command Get()
    {
        ...
        if (GroupKillEntity != null) { return GroupKillEntity; }
        if (GroupSacrifice != null) { return GroupSacrifice; }
        if (PortalDefineExitPoint != null) { return PortalDefineExitPoint; }
        if (PortalRemoveExitPoint != null) { return PortalRemoveExitPoint; }
        if (TunnelMakeExitPoint != null) { return TunnelMakeExitPoint; }
    ...
    public CommandHolder(CommandGroupKillEntity v) { GroupKillEntity = v; }
    public CommandHolder(CommandGroupSacrifice v) { GroupSacrifice = v; }
    public CommandHolder(CommandPortalDefineExitPoint v) { PortalDefineExitPoint = v; }
    public CommandHolder(CommandPortalRemoveExitPoint v) { PortalRemoveExitPoint = v; }
    public CommandHolder(CommandTunnelMakeExitPoint v) { TunnelMakeExitPoint = v; }
    ...
    public CommandHolder(Command v)
    {
        switch (v)
        {
            ...
            case CommandTokenSlotBuild s:
                TokenSlotBuild = s;
                break;
            case CommandGroupKillEntity s:
                GroupKillEntity = s;
                break;
            case CommandGroupSacrifice s:
                GroupSacrifice = s;
                break;
            case CommandPortalDefineExitPoint s:
                PortalDefineExitPoint = s;
                break;
            case CommandPortalRemoveExitPoint s:
                PortalRemoveExitPoint = s;
                break;
            case CommandTunnelMakeExitPoint s:
                TunnelMakeExitPoint = s;
                break;
            case CommandPing s:
                Ping = s;
                break;
...
[JsonDerivedType(typeof(CommandGroupKillEntity))]
[JsonDerivedType(typeof(CommandGroupSacrifice))]
[JsonDerivedType(typeof(CommandPortalDefineExitPoint))]
[JsonDerivedType(typeof(CommandPortalRemoveExitPoint))]
[JsonDerivedType(typeof(CommandTunnelMakeExitPoint))]
...
public sealed class CommandGroupKillEntity : Command
{
    [JsonPropertyName("entities")]
    public required EntityId[] Entities { get; set; }
}

public sealed class CommandGroupSacrifice : Command
{
    [JsonPropertyName("squads")]
    public required EntityId[] Squads { get; set; }
    [JsonPropertyName("target")]
...
public sealed class CommandPortalDefineExitPoint : Command
{
    [JsonPropertyName("portal")]
    public required EntityId Portal { get; set; }
    [JsonPropertyName("xy")]
    public required Position2D Xy { get; set; }
}

public sealed class CommandPortalRemoveExitPoint : Command
{
    [JsonPropertyName("portal")]
    public required EntityId Portal { get; set; }
}

public sealed class CommandTunnelMakeExitPoint : Command
{
    [JsonPropertyName("portal")]
    public required EntityId Portal { get; set; }
}
...
public class CommandRejectionReasonHolder
{
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public CommandRejectionReasonGlobalCooldown? GlobalCooldown { get; set; }
    /// <summary>
    ///  Some spells do have a cooldown
    /// </summary>
    [JsonPropertyName("Cooldown")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public CommandRejectionReasonCooldown? Cooldown { get; set; }
    /// <summary>
    ///  You run out of charges you need to wait `(power cost) * 10 / 2` ticks, or spell cooldown, whatever is longer
    /// </summary>
    [JsonPropertyName("OutOfChargesCooldown")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public CommandRejectionReasonOutOfChargesCooldown? OutOfChargesCooldown { get; set; }
    /// <summary>
    ...
    public CommandRejectionReason Get()
    {
        ...
        if (GlobalCooldown != null) { return GlobalCooldown; }
        if (Cooldown != null) { return Cooldown; }
        if (OutOfChargesCooldown != null) { return OutOfChargesCooldown; }
    ...
    public CommandRejectionReasonHolder(CommandRejectionReasonGlobalCooldown v) { GlobalCooldown = v; }
    public CommandRejectionReasonHolder(CommandRejectionReasonCooldown v) { Cooldown = v; }
    public CommandRejectionReasonHolder(CommandRejectionReasonOutOfChargesCooldown v) { OutOfChargesCooldown = v; }
    ...
    public CommandRejectionReasonHolder(CommandRejectionReason v)
    {
        switch (v)
        {
            case CommandRejectionReasonCardRejected s:
                CardRejected = s;
                break;
            case CommandRejectionReasonGlobalCooldown s:
                GlobalCooldown = s;
                break;
            case CommandRejectionReasonCooldown s:
                Cooldown = s;
                break;
            case CommandRejectionReasonOutOfChargesCooldown s:
                OutOfChargesCooldown = s;
                break;
...
[JsonDerivedType(typeof(CommandRejectionReasonGlobalCooldown))]
[JsonDerivedType(typeof(CommandRejectionReasonCooldown))]
[JsonDerivedType(typeof(CommandRejectionReasonOutOfChargesCooldown))]
...
///  You need to wait 10 ticks, after playing card, before playing another card
/// </summary>
public sealed class CommandRejectionReasonGlobalCooldown : CommandRejectionReason
{
...
///  Some spells do have a cooldown
/// </summary>
public sealed class CommandRejectionReasonCooldown : CommandRejectionReason
{
    [JsonPropertyName("cooldown_until")]
    public required Tick CooldownUntil { get; set; }
}
...
///  You run out of charges you need to wait `(power cost) * 10 / 2` ticks, or spell cooldown, whatever is longer
/// </summary>
public sealed class CommandRejectionReasonOutOfChargesCooldown : CommandRejectionReason
{
    [JsonPropertyName("cooldown_until")]
    public required Tick CooldownUntil { get; set; }
}
